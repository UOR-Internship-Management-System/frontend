...
export function CvOutputPanel({
  ...
  return (
    <Card aria-labelledby="cv-output-title" variant="outlined">
      <CardHeader className="s5-section-heading">
        <div>
          <CardTitle id="cv-output-title">CV output and actions</CardTitle>
          <p>Generate, save, and download the Student-owned ATS-compliant CV.</p>
        </div>
      </CardHeader>
      <CardContent className="s5-cv-output-panel">
        {savedCvPending ? (
