        ...
        <Routes>
          <Route element={<RootLayout />}>
            ...
            <Route
              ...
              element={<h1>Internship Management page</h1>}
            />
            <Route
              path={routePaths.adminCandidateFiltering}
              element={<h1>Candidate Filtering page</h1>}
            />
...
describe('RootLayout', () => {
  ...
  it.each([
    [routePaths.adminInternships, 'Internship Management page'],
    [routePaths.adminCandidateFiltering, 'Candidate Filtering page'],
    [routePaths.adminShortlists, 'Shortlists page'],
  ])('keeps %s inside the Admin workspace without duplicate theme controls', (path, heading) => {
