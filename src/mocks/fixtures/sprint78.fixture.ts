...
export const sprint78Ids = {
  ...
  shortlists: {
    frontendDraft: 'e1000000-0000-4000-8000-000000000001',

    backendFinalized: 'e1000000-0000-4000-8000-000000000002',
  },

  requiredSkills: {
    frontendReact: 'f1000000-0000-4000-8000-000000000001',

    frontendTypeScript: 'f1000000-0000-4000-8000-000000000002',

    backendJava: 'f1000000-0000-4000-8000-000000000003',

    backendSpring: 'f1000000-0000-4000-8000-000000000004',

    dataPython: 'f1000000-0000-4000-8000-000000000005',
  },
} as const
...
export const sprint78InternshipRequestsFixture: ApiInternshipRequestResponse[] = [
  {
    ...
    requiredSkills: [
      {
        requiredSkillId: sprint78Ids.requiredSkills.frontendReact,
        skillId: skillIds.react,
        skillName: 'React',
      },
      {
        requiredSkillId: sprint78Ids.requiredSkills.frontendTypeScript,
  ...
  },
  {
    ...
    requiredSkills: [
      {
        requiredSkillId: sprint78Ids.requiredSkills.backendJava,
        skillId: skillIds.java,
        skillName: 'Java',
      },
      {
        requiredSkillId: sprint78Ids.requiredSkills.backendSpring,
  ...
  },
  {
    ...
    requiredSkills: [
      {
        requiredSkillId: sprint78Ids.requiredSkills.dataPython,
...
export const sprint78CandidatesFixture: ApiCandidateFilteringCandidateResponse[] = [
  {
    ...
    matchingDeclaredSkills: [
      declaredSkill('a2000000-0000-4000-8000-000000000001', skillIds.react, 'React', 'ADVANCED'),
      declaredSkill(
  ...
  },
  {
    ...
    gpaAvailabilityStatus: 'AVAILABLE',
    matchingDeclaredSkills: [
      declaredSkill('a2000000-0000-4000-8000-000000000005', skillIds.java, 'Java', 'ADVANCED'),
      declaredSkill(
  ...
  },
  {
    ...
    matchingDeclaredSkills: [
      declaredSkill('a2000000-0000-4000-8000-000000000008', skillIds.python, 'Python', 'BEGINNER'),
    ],
...
export const sprint78ShortlistCandidatesFixture: Record<string, ApiShortlistCandidateResponse[]> = {
...
export const sprint78ShortlistsFixture: ApiShortlistResponse[] = [
  {
    shortlistId: sprint78Ids.shortlists.frontendDraft,
    ...
    guidanceWarning: 'The selected candidate count is above the request guidance value.',
    version: 5,
  ...
  {
    shortlistId: sprint78Ids.shortlists.backendFinalized,
