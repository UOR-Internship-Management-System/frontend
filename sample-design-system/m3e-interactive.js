...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.m3-chip, .m3e-chip').forEach((chip) => {
    chip.addEventListener('click', (e) => {
      if (
        e.target.classList.contains('m3-chip__remove') ||
        e.target.classList.contains('m3e-chip-close')
      ) {
  ...
  const dialogScrim =
    document.getElementById('m3e-dialog-demo') || document.getElementById('dialogScrim')
  const openDialogBtn =
    document.getElementById('open-dialog-btn') || document.getElementById('openDialogBtn')
  ...
  // 7. Snackbar Trigger
  const snackbar =
    document.getElementById('m3e-snackbar-demo') || document.getElementById('snackbarDemo')
  const openSnackbarBtn =
    document.getElementById('open-snackbar-btn') || document.getElementById('openSnackbarBtn')
  ...
  document.querySelectorAll('.m3e-toolbar-btn').forEach((btn) => {
    btn.addEventListener('click', () => {
      if (btn.parentElement) {
        btn.parentElement
          .querySelectorAll('.m3e-toolbar-btn')
  ...
  document.querySelectorAll('.side a, .m3e-showcase-nav a').forEach((anchor) => {
    anchor.addEventListener('click', function (e) {
      ...
      if (targetElem) {
        ...
        document
          .querySelectorAll('.side a, .m3e-nav-item')
