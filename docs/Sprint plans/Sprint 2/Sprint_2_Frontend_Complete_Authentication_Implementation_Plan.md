...
1. **Student** â€” sign-up, auto-verification, OTP, initial password creation, login, logout, forgot-password reset, and protected Student routing.
2. **Department Admin** â€” sign-in using predefined Admin credentials, OTP-based forgot-password reset, Admin token/session handling, and protected Admin routing.
...
| State     | UI                                                                  |
| --------- | ------------------------------------------------------------------- |
| `loading` | Spinner and text such as â€œYour details are verifying ...â€        |
...
- Left welcome panel: â€œWelcome back, administrator.â€ or approved equivalent.
- Right login card: â€œAdmin Loginâ€.
...
- No â€œAdmin Sign Upâ€ link.
- No â€œRequest Admin Accountâ€ workflow unless it is a static support note.
...
### Day 1 â€” Contract and Frontend Foundation
...
### Day 2 â€” Student Onboarding and Login
...
### Day 4 â€” Unified Student/Admin Password Reset
...
### Day 5 â€” Integration, QA, and Demo Hardening
...
| ---------- | ----------------------- | -------------------------------------------------------------------------- |
| FE-INT-001 | Student full onboarding | Sign-up â†’ OTP â†’ create password â†’ login â†’ Student dashboard shell. |
| FE-INT-002 | Student forgot password | Forgot password â†’ OTP â†’ reset password â†’ login.                      |
| FE-INT-003 | Admin login             | Admin login â†’ `/auth/me` role check â†’ Admin dashboard shell.           |
| FE-INT-004 | Admin forgot password   | Forgot password â†’ OTP â†’ create password â†’ login.                     |
